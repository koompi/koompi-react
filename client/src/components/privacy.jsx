  ...
  return (
    <>
      ...
      <div className="ui container containerPrivacy">
        ...
        <p>KOOMPI we operates the https://koompi.com website .</p>
        <p>
          ...
          accessible from https://koompi.com
        </p>
        ...
        <h4>Usage Data</h4>
        <p>
          We may also collect information how the Service is accessed and used. This
          Usage Data may include information such as your computer&amp;#39;s Internet
          Protocol address, browser type, browser version, the pages of our Service
        ...
        <h2>Use of Data</h2>
        <p>KOOMPI uses the collected data for various purposes:</p>
        <ul>
        ...
        <p>
          If you are located outside Cambodia and choose to provide information to
          us, please note that we transfer the data, including Personal Data, to
          Cambodia and process it there.
        </p>
        <p>
        ...
        <p>
          KOOMPI will take all steps reasonably necessary to ensure that your data is
        ...
        <p>
          KOOMPI may disclose your Personal Data in the good faith belief that such
          action is necessary to:
        </p>
        <ul>
          <li>To comply with a legal obligation</li>
          <li>To protect and defend the rights or property of KOOMPI</li>
          <li>
        ...
        <ul>
          <li>By email: koompi.com@gmail.com</li>
          <li>By visiting this page on our website: https://koompi.com/contact</li>
        </ul>
      </div>
      <Footer />
    </>
