                ...
                <div className="container">
                  ...
                  >
                    <TabPane className="text" tab="Coding" key="1">
                      Build code, run multiple virtual machines, and see your
                      work take shape — faster than ever before.
                    </TabPane>
                    <TabPane className="text" tab="Video" key="2">
                      Create professional-quality music in Logic Pro X with
                      multiple tracks and plug-ins, virtual instruments,
                      automation, and more.
                    </TabPane>
                  ...
                  <div className="container">
                    <Typography>
                      ...
                      <Paragraph className="text professional-performance-p">
                        With an enhanced processor and discrete graphics, up to
                        16 GB of memory and up to 1 TB of fast SSD storage, the
                        KOOMPI E11 is built to provide all the horsepower you
                        need. Incredible multitasking efficiency, faster image
                        processing and smoother gaming experiences are now all
                        in one. The upgraded high-speed Wi-Fi and Bluetooth 5.0
                        ensures better connection without any worries.
                      </Paragraph>
                    </Typography>
                    <center>
                      ...
                      <img src="/img/insidelatop.jpg"></img>
                    </center>
                  </div>
                </div>
                {/* ========Power battery====== */}
                  ...
                  <div className="container">
                    <Typography className="text-container">
                      ...
                      <Paragraph className="p-of-powerBattery">
                        ...
                        charge. Enjoy movies on your long flight without
                        plugging in.
                      </Paragraph>
                    </Typography>
                    <div>
                  ...
                  <div className="text-container">
                    <Typography>
                      ...
                      <Paragraph className="text-of-slim">
                        A professional notebook that's also portable. The
                        elegant metallic body with perfect diamond cutting and
                        sandblast finishing is just 14.6 mm thin and weighs only
                        1.33 kg. Comfortable to take it anywhere for work or
                        entertainment.
                      </Paragraph>
                    </Typography>
                    <div className="text-container">
                      <Row>
                        <Col span={12}>
                          <div>
                            ...
                            <Paragraph className="p-of-slim">Thin</Paragraph>
                          </div>
                        </Col>
                        <Col span={12}>
                          <div>
                            ...
                            <Paragraph className="p-of-slim">Light</Paragraph>
                          </div>
                        </Col>
                      </Row>
                    </div>
